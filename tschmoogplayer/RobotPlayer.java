...
public strictfp class RobotPlayer {
    ...
    static void runArchon() throws GameActionException {
        ...
        while (true) {
            ...
            try {
                ...
                //try auto win (more then 10,000 bullets)
                tryAutoWin();
    ...
    static void runGardener() throws GameActionException {
        ...
        while (true) {
            ...
            try {
                ...
                //Randomly plant a tree
                tryPlantTree(dir);

                //Water tree if possible
                tryWaterTree();
    ...
    public static void tryPlantTree(Direction dir) throws GameActionException {
    ...
    public static void tryWaterTree() throws GameActionException {
        if (rc.canWater()) {
            TreeInfo[] nearbyTrees = rc.senseNearbyTrees();
    ...
    public static void tryAutoWin() throws GameActionException {
